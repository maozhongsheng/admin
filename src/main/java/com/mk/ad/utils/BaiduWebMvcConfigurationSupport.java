...
public class BaiduWebMvcConfigurationSupport implements WebMvcConfigurer {
    ...
    private String [] whitelist = {"/api/user/login","/api/userIdByToken","/api/selectRequetBySlotId","/api/selectUpperBySlotId","/api/adminIndexSlotId","/api/adminSelectMediaName","/api/adminSelectSlotName","/api/adminSelectSspCompanyName","/api/adminSelectSlotTypeName","/api/adminUnionSlotId","/api/adminSelectUnionName","/api/adminSelectUnionMediaName","/api/adminSelectUnionSlotName","/api/adminIndexUnionSlot","/api/selectUnion","/api/dspIndexSelectSlotId","/api/sspAlltoRedis","/api/adminImport","/api/importDataList","/api/upImportStatus/{id}/{if_update}","/api/importDataRemove/{id}","/api/importSspList","/api/downLoadTemplate"};
